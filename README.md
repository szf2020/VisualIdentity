...
## 🌟 项目简介
在 **AI 应用落地** 的过程中，**模型管理** 与 **多任务识别** 的高效运行一直是开发者的痛点。  
无论是 **对象检测、分类、分割**，还是 **姿态估计、定向检测**，往往需要同时部署多个模型，传统方案在 **效率** 和 **易用性** 上总会遇到瓶颈。  
...
- 支持 **YOLOv5u - YOLOv12、YOLO World、YOLO-E** 全系列模型  
